...
$(document).ready(function(){
    $('#radio_porra1').click(function () {
        $('#div_porra_existente').hide();
        $('#div_porra_nueva').show();
        $('#insertar_nueva_porra').val("true");
    });
    $('#radio_porra2').click(function () {
        $('#div_porra_nueva').hide();
        $('#div_porra_existente').show();
        $('#insertar_nueva_porra').val("false");
        CargarPorras();
    });
});
